  ...
  return (
    <div className='absolute top-0 w-full h-full grid grid-cols-7'>
        <div className='border-r-2 border-r-white/20 relative'>
            <Image alt="social" src={whatsapp} className='absolute w-14 -right-7 top-36 drop-shadow-lg' />
            <Image alt="social" src={tiktok} className='absolute w-14 -right-7 top-[450px] drop-shadow-lg' />
        ...
        <div className='border-r-2 border-r-white/20 relative'>
            ...
            <Image alt="social" src={facebook} className='absolute w-14 -right-7 top-80 drop-shadow-lg' />
            <Image alt="social" src={snapchat} className='absolute w-14 -right-7 top-[500px] drop-shadow-lg' />
        </div>
        <div className='border-r-2 border-r-white/20 relative'></div>
        <div className='border-r-2 border-r-white/20 relative'></div>
        <div className='border-r-2 border-r-white/20 relative'>
