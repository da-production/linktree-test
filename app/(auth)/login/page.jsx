    ...
    <>
      <div className="flex min-h-screen">
        ...
        <div className="flex flex-row w-full">
          {/* Sidebar */}
          <div className="hidden lg:flex flex-col justify-between text-white bg-[#1e5af9] lg:p-8 xl:p-12 lg:max-w-sm xl:max-w-lg">
          ...
          <div className="flex flex-1 flex-col items-center justify-center px-10 relative">
            ...
            <div className="flex flex-1 flex-col  justify-center space-y-5 max-w-md">
              ...
              <div className="flex flex-col max-w-md space-y-5">
                ...
                <button onClick={()=> signIn({redirect:'account'})} className="flex items-center justify-center flex-none px-3 py-2 md:px-4 md:py-3 border-2 rounded-lg font-medium border-black relative">
